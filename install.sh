...
echo "  /i2c-update-adr [N] [changes]  — update ADR (with downstream cascade)"
echo "  /i2c-update-rfc [N]            — update RFC after upstream ADR change"
echo "  /i2c-code --rfc N             — implement RFC from scratch"
echo "  /i2c-code --feature N \"...\"   — add a feature to existing code"
echo "  /i2c-verify-rfc [N]            — verify implementation"
echo "  /i2c-patch-rfc [N]             — patch after RFC change"
echo "  /i2c-auto [--from=rfc|code]    — autonomous create-rfc → code loop"
