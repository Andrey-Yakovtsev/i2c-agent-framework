...
- `.i2c/config.md`
- `.i2c/MEMORY.md`
- `.i2c/framework/templates/PRD.md` (шаблон)
...
- Содержимое `.i2c/framework/templates/PRD.md`
- Содержимое `.i2c/MEMORY.md`
...
- `.i2c/config.md`
- `.i2c/MEMORY.md`
- `.i2c/framework/templates/ADR.md`
...
- Содержимое `.i2c/framework/templates/ADR.md`
- Содержимое `.i2c/MEMORY.md`
...
- Содержимое `.i2c/framework/templates/RFC.md`
- Содержимое `.i2c/MEMORY.md`
...
- `.i2c/framework/templates/IMPL.md`
- `.i2c/MEMORY.md`
...
2. Делегируй субагенту с промптом из `.i2c/framework/diagnostics/review-checklist.md`
...
**Фреймворк встроен в проект** в `.i2c/framework/`. Все файлы доступны локально.
...
<project>/.i2c/
  ...
  MEMORY.md              ← из .i2c/framework/templates/MEMORY.md
  GOALS.md               ← создать
  JOURNAL.md             ← создать
...
`MEMORY.md` — скопируй структуру из `.i2c/framework/templates/MEMORY.md`.
...
Фреймворк уже встроен `install.sh`. Проверь что файл `QWEN.md` проекта содержит строку `@.i2c/framework/QWEN.md`.
Если нет — добавь её. Агенты и команды уже установлены в `.i2c/framework/` и `.qwen/commands/`.
