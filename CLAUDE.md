...
<project>/.claude/
  settings.json          ← скопировать из ~/i2c-agent-framework/templates/claude-settings.json
```
...
Создано:
  ...
  .claude/settings.json    — pre-approved инструменты (docker-compose, тестовые команды)
